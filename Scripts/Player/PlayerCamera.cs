...
public class PlayerCamera : Camera2D {
	public Vector2 ActualPosition {set {actualPos = value;} get {return actualPos;}}
	...
	public void UpdateCamera(float delta) {
		...
		actualPos.x = Mathf.Lerp(actualPos.x, player.GlobalTransform.origin.x, delta * 4f);
		actualPos.x = Mathf.Lerp(actualPos.x, mousePos.x, delta * 0.4f);
		actualPos.y = Mathf.Lerp(actualPos.y, player.GlobalTransform.origin.y - h, delta * 4f);

		Transform2D _tr = this.GlobalTransform;
